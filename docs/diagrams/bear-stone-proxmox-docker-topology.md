...
- `docker10`, `codex-appliance`, `docker17`, and `docker69` run on ProxMox1; `docker14` runs alone on ProxMox2.
- All five Docker VMs keep their durable disks on shared `Prox-NFS01` storage.
- `codex-appliance` is summarized as the Codex/MCP runtime plus OneNote indexers, admin UI, and service agents.
