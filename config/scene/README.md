...
| File | Why it matters |
| --- | --- |
| [![YAML source: monthly_colors](https://img.shields.io/static/v1?label=YAML&message=monthly_colors&color=lightgrey&logo=github&logoColor=181717)](monthly_colors.yaml) | Exterior lighting colors mapped to holidays and seasons. |
| [![YAML source: living_room](https://img.shields.io/static/v1?label=YAML&message=living_room&color=lightgrey&logo=github&logoColor=181717)](living_room.yaml) | Core living-room presets: TV Time, red alert, new daytime cool and evening amber defaults. |
